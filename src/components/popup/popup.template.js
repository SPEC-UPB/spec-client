                ...
                <div>
                  <div className="card">
                    <div className="card-body">
                      ...
                      de eficiencia entre: {props.date ? normalizarFormatoFecha(props.date ):props.date } y {props.currentDateEnd ? normalizarFormatoFecha(props.currentDateEnd)+" ":props.currentDateEnd+" "} 
